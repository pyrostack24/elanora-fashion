          ...
          {featuredProducts.map(product => (
            <div key={product.id} className="product-card-new">
              <div className="product-image-container" onClick={() => navigate(`/product/${product.id}`)}>
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 20 20" fill={isInWishlist(product.id) ? "currentColor" : "none"}>
                    <path d="M17.367 3.633a4.583 4.583 0 00-6.484 0L10 4.517l-.883-.884a4.583 4.583 0 10-6.484 6.484l.884.883L10 17.483 16.483 11l.884-.883a4.583 4.583 0 000-6.484z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </button>
              </div>
